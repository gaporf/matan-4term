...
\part{Поверхностный интеграл}
    ...
    \subsection{Определение}
        ...
        $M$~--- просто гладкое двумерное многообразие в $\mathbb{R}^3$.
        
        $\varphi : O \subset \mathbb{R}^2 \rightarrow \mathbb{R}^3$~--- параметризация.
        ...
        мера на $\mathcal{A}_M$, $S(E) = \iint\limits_{\varphi^{-1}(E)} \left| \varphi'_u \times \varphi'_v \right| du dv$.
        
    \subsection{Пример}
    
        $E \subset M$~--- компактное, $\varphi : O \rightarrow M$~--- гомеоморфизм.
        
        компактно, значит лежит в $\mathcal{A}_m$.
        
        замкнутые измеримы, значит и открытые измеримы.
        
        Замечание: определение $S(E)$ не зависит от параметризации.
