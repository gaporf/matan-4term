...
\newpage
    ...
    \section{Единственность плотности}
        ...
        \subsection{Следствие}
            ...
            Плотность $\nu$ относительно $\mu$ определена однозначно с точностью до равенства почти везде.
    ...
    \section{Теорема об образе меры Лебега при диффеоморфизме}
        ...
        \subsection{Лемма}
            ...
            $f : \underset{\text{откр.}}{O} \subset \mathbb{R}^m \rightarrow \mathbb{R}$,~--- непрерывное. $A$~--- измеримое, $A \subset Q \subset \overline{Q} \subset O$.
        
            Тогда $\int\limits_{\substack{A \subset G \\ G \text{~--- открытое}}} \left( \lambda (G) \sup\limits_{G} f \right) = \lambda A \sup\limits_{A} f$.
            
            Без доказательства.
        
        \subsection{Теорема}
        
            $\Phi : O \subset \mathbb{R}^m \rightarrow \mathbb{R}^m$~--- диффеоморфизм. $A \in \mathcal{M}^m$, $A \subset O$. Тогда $\lambda \Phi(A) = \int\limits_{A} \left| \det \Phi'(a) \right| d \lambda$.
        ...
        \subsubsection{Доказательство}
            ...
            \begin{enumerate}
                ...
                \item Оценка $\nu A \leqslant \sup J_{\Phi} \lambda A$, верна для случая, когда $A$~--- открытое множество.
                    ...
                    $\nu G \leqslant \sup\limits_{G} J_{\Phi} \cdot \lambda G$ и $\nu A \leqslant \nu G \leqslant \lambda A \sup\limits_{A} f$.
...
\newpage
    ...
    $f : X \xrightarrow[\text{п.в.}]{} \overline{\mathbb{R}}$, $\mathrm{ess}\sup f = \inf \left\{ A \in \overline{\mathbb{R}} : f(x) \leqslant A \ \text{п.в.} \right\}$.
        ...
        \subsection{Свойства}
            ...
            \begin{enumerate}
                ...
                \item $\left| \int\limits_X fg \right| \leqslant \mathrm{ess} \sup |f| \cdot \int\limits_X |g|$.
    ...
    \section{Теорема о вложении пространств $L^p$}
        ...
        \subsection{Следствие}
            ...
            $\mu E < +\infty$, $1 \leqslant s < r \leqslant +\infty$.
...
\newpage
    ...
    \section{Измеримое множество на простом гладком двумерном многообразии в $\mathbb{R}^3$}
        ...
        $E \subset M$~--- измеримое (по Лебегу), если $\varphi^{-1}(E)$~--- измерим в $\mathbb{R}^2$.
...
\newpage
    ...
    \section{Фундаментальная последовательность, полное пространство}
        ...
        Пусть $X$~--- метрическое пространство, последовательность $x_n \in X$ называется фундаментальной, если:
        
        $$\forall \varepsilon > 0 : \exists N : \forall n_1, n_2 > N : | x_{n_1} - x_{n_2} | < \varepsilon$$.
        
        Пространство, в котором любая фундаментальная последовательность сходится к элементу этого же пространства, называется \textit{полным}.
    ...
    \section{Плотность в $L^p$ множества ступенчатых функций}
        ...
        Тогда $\left\{ f \in L^p : f \text{~--- ступ.} \right\}$~--- плотно $L^p$.
    ...
    \section{Лемма Урысона}
        ...
        \subsection{Определение}
            ...
            $X$~--- \textit{топологическое} пространство, если $\forall F_1$, $F_2$~--- замкнутых подмножеств, верно: $F_1 \bigcap F_2 = \varnothing$.
...
\newpage
    ...
    \section{Ротор, дивиргенция векторного поля}
    ...
    \section{Соленоидальность бездивергентного векторного поля}
        ...
        \subsection{Теорема}
            ...
            \subsubsection{Доказательство}
                ...
                $\Leftarrow$ $\mathrm{div} A = 0$. Ищем векторный потенциал $B : \mathrm{rot} B = A$.
                    ...
                    $\varphi'_x(x, y) + A_3(x, y, z) - A_3(x, y, z_0) = A_3$, $\varphi'_x(x, y) = A_3(x, y, z_0)$ и $\varphi = \int\limits^x_{x_0} A_3(x, y, z_0) dx + g(y)$.

    \newpage
    
    \section{Бескоординатное определение дивергенции}
...
\newpage
    ...
    \section{Коэффициенты Фурье}
        ...
        $\left\{ e_k \right\}$~--- ортонормированная система векторов в $\mathcal{H}$, $x \in \mathcal{H}$.
    ...
    \section{Теорема о свойствах частичных сумм ряда Фурье. Неравенство Бесселя}
        ...
        $\left\{ e_k \right\}$~--- ортонормированная система $\mathcal{H}$, $x \in \mathcal{H}$, $n \in \mathbb{N}$. $S_n := \sum\limits_{k = 1}^n c_k(x) e_k$, $\mathcal{L} := \Lin(e_1, \ldots, e_n)$.
