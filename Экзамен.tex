...
\part{27.04.2020}
    ...
    \subsection{Дивергенция}
        ...
        \subsubsection{Следствие}
            ...
            $\vec{l}$~--- фиксированное направление в $\mathbb{R}^3$.
            
            $\dfrac{\partial f}{\partial l} = \langle \mathrm{grad} f, l \rangle = \dfrac{\partial f}{\partial x_1} l_1 + \dfrac{\partial f}{\partial x_2} l_2 + \dfrac{\partial f}{\partial x_3} l_3$.
            
            $\iiint\limits_V \dfrac{\partial f}{\partial l} (x, y, z) dx dy dz = \iint\limits_{\partial V} f(x, y, z) \langle l, n_0 \rangle dS$.
            
            $\partial V_\langle (f l_1, f l_2, f l_3), n_0 \rangle dS = \int\limits_{\partial \Omega} Pdx + Q dy + R dz$.
            
            $\int ( R'_y - Q'_z) dy dz + (P'_z - R'_x) dz dx + (Q'_x - P'_y) dx dy = \int\limits_{\partial \Omega} P dx + Q dy + R dz$.
    ...
    \subsection{Соленоидальное поле}
        ...
        Поле $V$~--- соленоидальное в $\Omega$ если существует векторный потенциал, т.е. существует такое векторное поле $B$, что $\mathrm{rot} B = V$.
...
\newpage
    ...
    \subsection{Коэффициенты Фурье}
        ...
        $\left\{ e_k^2 \right\}$~--- ортогональная система векторов, $x \in \mathcal{H}$.
    ...
    \subsection{Теорема о свойствах частичных сумм ряда Фурье}
    
        $\left\{ e_k \right\}$~--- ось $\mathcal{H}$, $x \in \mathcal{H}$, $n \in \mathbb{N}$. $S_n := \sum\limits_{k = 1}^n c_k(x) e_k$, $\mathcal{L} := \Lin(e_1, \ldots, e_n)$.
    ...
    \subsection{Теорема Рисса-Фишера}
        ...
        \begin{enumerate}
            ...
            \item $x = \sum\limits_{k = 1}^{+\infty} c_k(x) e_k \Longleftrightarrow \sum \left| c_k(x) \right|^2 \| e_k \|^2 = \| x \|^2$ (неравенство Бесселя).
    ...
    \subsection{Базис}
        ...
        \begin{enumerate}
            ...
            \item ортогональная система векторов~--- базис, если $\forall x \in \mathcal{H} : x = \sum c_k(x) e_k$.
            
            \item ортогональная система векторов полная, если не $\exists z : z \perp \left\{ e_k \right\}$.
            
            \item ортогональная система векторов замкнута если $\forall x \in \mathcal{H}$ выполняется уравнение замкнутости, т.е. $\sum \left| c_k(x) \right|^2 \| e_k \|^2 = \| x \|^2$.
            
        \end{enumerate}
            
    \subsection{Теорема о характеристике базиса}
